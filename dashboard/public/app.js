...
<div style="text-align: center; margin-top: 2rem; padding-top: 2rem; border-top: 1px solid hsl(var(--border));">
  ...
  // Replace with actual addresses from user object
   const wallets = {
    ...
    solana: { label: "SOL", address: "HThiJjtMC79A1m3vnRWjkHR5aL7MtpAT96iTk6t7aSNG", qr: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=HThiJjtMC79A1m3vnRWjkHR5aL7MtpAT96iTk6t7aSNG" },
  };
